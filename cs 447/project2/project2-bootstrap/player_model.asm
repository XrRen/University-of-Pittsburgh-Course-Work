...
.data
	...
	array_of_player_structs:	.word	0:100 # Total size = 25pixels * 4words (x,y,size,move)
...
player_get_element:
	la	t0, array_of_player_structs
				# First we load the address of the beginning of the array
	mul	t1, a0, player_size	# Then we multiply the index by 12
