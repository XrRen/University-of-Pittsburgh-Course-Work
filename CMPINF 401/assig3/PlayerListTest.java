...
// (given the same initial input file).
...
public class PlayerListTest
{
	public static void main(String [] args) throws IOException
	{
		...
		System.out.println(allPlayers.toString());  // Return formatted String containing
												// all players.  See output for formatting.
		...
		for (int i = 0; i < names.length; i++)
		{
			...
			if (play != null)
			{
				...
				// will discuss this issue) in lecture (see Lecture 17 Powerpoint slides).
