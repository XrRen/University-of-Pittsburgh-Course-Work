...
public class AirlineSystem {
	...
	public void readGraph () throws IOException {
		...
		int fileSize = fileScan.nextInt();
		cityNames = new String[fileSize];
		fileScan.nextLine();
		//TODO1: Complete this method to read the graph from the input file
		//      (e.g., data1.txt)
		G = new Digraph(fileSize);
	...
	public void printGraph () {
		...
		{
			StringBuilder print = new StringBuilder(cityNames[i] + ": ");
			for(DirectedEdge e : G.adj(i))
			{
				print.append( cityNames[e.to()] +" "); 
			}
